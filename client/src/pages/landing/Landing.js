    ...
    <Container>
      <Row>
        <Col md="7" className="mx-auto text-center">
          <h1 className="landing-intro-title my-4">Fully-featured React Bible & Visual Demonstration of the Promises </h1>

          <p className="landing-intro-subtitle">The eyes of your understanding being enlightened; that ye may know what is the hope of his calling, and what the riches of the glory of his inheritance in the saints.</p>
            
          <p className="landing-intro-subtitle">Easy to use Research content.</p>
        ...
        <Row>
          <Col md={9} lg={8} className="mx-auto">
            <FaqQuestion
              ...
              answer={<>You have access to the Software's online support services via email for six (6) months from the purchase date. Please contact us at <a href="mailto:info@teoyubelab.io">info@teoyubelab.io</a> for any questions.</>}
            />
            <FaqQuestion
